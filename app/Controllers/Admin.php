            ...
            if (in_array($image->getMimeType(), $authorizedExtension)) {
                ...
                if ($image->getSize() <= $maximumSize) {
                    ...
                    if ($ancienNomImg != "placeholder.jpg") {
                        ...
                        $session->setFlashdata('successProdUpdate', 'Le produit a bien été maodifé.');
                    }else {
                        $produit->save();
                    ...
                    $session->setFlashdata('errorProdUpdate', 'La taille maximale de l\'image doit être de 10Mo.');
                }
            } else {
