<main class="flex justify-center mt-16 px-4">
    ...
    <div class="w-full max-w-2xl">
        ...
        <!-- Bouton retour -->
        <div class="mb-6">
            <?= anchor('admin/listeproduits/1', '<i class="fas fa-arrow-left mr-2"></i> Retour', ['class' => "inline-flex items-center bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-lg shadow transition"]) ?>
        </div>
        ...
        echo form_open('admin/modifproduit', $input);
        ?>
        ...
        <div>
            <?php
            $session = session();
            if ($session->getFlashdata('errorProdUpdate')) {
                echo '
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4">
                        <span class="block sm:inline">' . $session->getFlashdata("errorProdUpdate") . '</span>
                    </div>';
            } elseif ($session->getFlashdata('successProdUpdate')) {
                echo '
                    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4">
                        <span class="block sm:inline">' . $session->getFlashdata("successProdUpdate") . '</span>
                    </div>';
            }
            ?>
        </div>
        ...
        <div>
            ...
            <?= form_input('nomProduit', $produit->nom, [
        ...
        <div>
            ...
            <?= form_textarea('descProduit', $produit->description, [
                'class' => 'w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500',
                'rows' => 5,
                'id' => 'description',
        ...
        <div>
            ...
            <?= form_input('prixProduit', $produit->prix, [
                'class' => 'w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500',
                'id' => 'prixProduit',
                'placeholder' => '0.00',
                'step' => '0.01',
        ...
        <div>
            ...
            <?= form_input('stockProduit', $produit->stock, [
                'class' => 'w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500',
                'id' => 'stockProduit',
                'placeholder' => '10',
                'required' => true
        ...
        <div>
            ...
            <?= form_upload('imageProduit', $produit->categorie_id, [
                'class' => 'w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500',
                'id' => 'imageProduit'
            ]) ?>
        </div>
        ...
        <!-- BOUTON SUBMIT -->
        <div>
            <?= form_submit('modifProduit', 'Modifier le produit', [
                'class' =>
